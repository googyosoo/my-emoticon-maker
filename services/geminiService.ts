 ...
 */
function getFallbackPrompt(prompt: string): string {
    // Simple fallback for emoji style
    return `Create a 3D cartoon character of the person in this photo. Make it cute and expressive. Solid background.`;
}
